use utf8;
package JournalEd::Schema::Result::Page;
...
Related object: L<JournalEd::Schema::Result::Navigation>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7WwnEOg+3uwd8R6KGKFHfQ
